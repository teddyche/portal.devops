...
def create_app(config: Optional[dict] = None) -> Flask:
    ...
    for bp in (auth_bp, auth_admin_bp, pages_bp, sre_bp, pssit_bp, cad_bp, health_bp, ldap_bp, kubi_bp, gitlab_bp, ordo_bp, aap_checker_bp, clpass_bp, annuaire_bp, jfrog_bp, clp_builder_bp, clp_bp):
